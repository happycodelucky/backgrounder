...
class IOSPeriodicDispatcherTest {
    private val periodicId = TaskId("dev.backgrounder.test.periodic")
    private val otherId = TaskId("dev.backgrounder.test.periodic2")
    ...
    private class RecordingListener : BackgrounderEventListener {
        ...
        override fun onScheduled(
            taskId: TaskId,
            request: dev.backgrounder.WorkRequest,
        ) = Unit
